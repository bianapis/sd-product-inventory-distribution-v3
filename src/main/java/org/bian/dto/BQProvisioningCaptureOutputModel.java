...
/**
 * BQProvisioningCaptureOutputModel
 */
public class BQProvisioningCaptureOutputModel   {
  ...
  private String provisioningCaptureActionTaskReference = null;

  private Object provisioningCaptureActionTaskRecord = null;

  private String provisioningCaptureRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Provisioning instance capture service call 
   * @return provisioningCaptureActionTaskReference
  **/

  public String getProvisioningCaptureActionTaskReference() {
    return provisioningCaptureActionTaskReference;
  }

  public void setProvisioningCaptureActionTaskReference(String provisioningCaptureActionTaskReference) {
    this.provisioningCaptureActionTaskReference = provisioningCaptureActionTaskReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The capture service call consolidated processing record 
   * @return provisioningCaptureActionTaskRecord
  **/

  public Object getProvisioningCaptureActionTaskRecord() {
    return provisioningCaptureActionTaskRecord;
  }

  public void setProvisioningCaptureActionTaskRecord(Object provisioningCaptureActionTaskRecord) {
    this.provisioningCaptureActionTaskRecord = provisioningCaptureActionTaskRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Provisioning structured input transaction/record 
   * @return provisioningCaptureRecordReference
  **/

  public String getProvisioningCaptureRecordReference() {
    return provisioningCaptureRecordReference;
  }

  public void setProvisioningCaptureRecordReference(String provisioningCaptureRecordReference) {
    this.provisioningCaptureRecordReference = provisioningCaptureRecordReference;
  }
