...
/**
 * BQDistributionCaptureOutputModel
 */
public class BQDistributionCaptureOutputModel   {
  ...
  private String distributionCaptureActionTaskReference = null;

  private Object distributionCaptureActionTaskRecord = null;

  private String distributionCaptureRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Distribution instance capture service call 
   * @return distributionCaptureActionTaskReference
  **/

  public String getDistributionCaptureActionTaskReference() {
    return distributionCaptureActionTaskReference;
  }

  public void setDistributionCaptureActionTaskReference(String distributionCaptureActionTaskReference) {
    this.distributionCaptureActionTaskReference = distributionCaptureActionTaskReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Distribution structured input transaction/record 
   * @return distributionCaptureRecordReference
  **/

  public String getDistributionCaptureRecordReference() {
    return distributionCaptureRecordReference;
  }

  public void setDistributionCaptureRecordReference(String distributionCaptureRecordReference) {
    this.distributionCaptureRecordReference = distributionCaptureRecordReference;
  }
