...
/**
 * BQProvisioningInitiateOutputModel
 */
public class BQProvisioningInitiateOutputModel   {
  private String provisioningInstanceReference = null;

  private String provisioningInitiateActionReference = null;

  private Object provisioningInitiateActionRecord = null;

  private String provisioningInstanceStatus = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Provisioning instance 
   * @return provisioningInstanceReference
  **/

  public String getProvisioningInstanceReference() {
    return provisioningInstanceReference;
  }

  public void setProvisioningInstanceReference(String provisioningInstanceReference) {
    this.provisioningInstanceReference = provisioningInstanceReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to an Initiate service call 
   * @return provisioningInitiateActionReference
  **/

  public String getProvisioningInitiateActionReference() {
    return provisioningInitiateActionReference;
  }

  public void setProvisioningInitiateActionReference(String provisioningInitiateActionReference) {
    this.provisioningInitiateActionReference = provisioningInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Provisioning instance (e.g. initialised, pending, active) 
   * @return provisioningInstanceStatus
  **/

  public String getProvisioningInstanceStatus() {
    return provisioningInstanceStatus;
  }

  public void setProvisioningInstanceStatus(String provisioningInstanceStatus) {
    this.provisioningInstanceStatus = provisioningInstanceStatus;
  }
